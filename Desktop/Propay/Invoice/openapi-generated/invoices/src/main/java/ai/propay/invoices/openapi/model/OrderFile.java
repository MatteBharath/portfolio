...
public class OrderFile {
   ...
   */
  public OrderFile(String filename, String url, List<String> tags) {
      this.filename = filename;
      this.url = url;
      this.tags = tags;
  }

  public OrderFile filename(String filename) {
    this.filename = filename;
    return this;
  }
  ...
  public OrderFile url(String url) {
    this.url = url;
    return this;
  }
  ...
  public OrderFile tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public OrderFile addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filename, orderFile.filename) &&
        Objects.equals(this.url, orderFile.url) &&
        Objects.equals(this.tags, orderFile.tags);
  }
